...
export class NotebookHandle {
    ...
    add_cell(index, cell_id, cell_type) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(cell_id, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(cell_type, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
    ...
    add_cell_after(cell_id, cell_type, after_cell_id) {
        ...
        try {
            ...
            const ptr1 = passStringToWasm0(cell_type, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
            const len1 = WASM_VECTOR_LEN;
            var ptr2 = isLikeNone(after_cell_id) ? 0 : passStringToWasm0(after_cell_id, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
    ...
    add_conda_dependency(pkg) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(pkg, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
            const len0 = WASM_VECTOR_LEN;
    ...
    move_cell(cell_id, after_cell_id) {
        ...
        try {
            ...
            const ptr0 = passStringToWasm0(cell_id, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
            const len0 = WASM_VECTOR_LEN;
            var ptr1 = isLikeNone(after_cell_id) ? 0 : passStringToWasm0(after_cell_id, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
    ...
    constructor(notebook_id) {
        const ptr0 = passStringToWasm0(notebook_id, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
        const len0 = WASM_VECTOR_LEN;
    ...
    set_conda_channels(channels_json) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(channels_json, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
            const len0 = WASM_VECTOR_LEN;
    ...
    set_conda_python(python) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            var ptr0 = isLikeNone(python) ? 0 : passStringToWasm0(python, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
    ...
    set_metadata(key, value) {
        try {
            ...
            const ptr0 = passStringToWasm0(key, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(value, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
            const len1 = WASM_VECTOR_LEN;
    ...
    set_uv_requires_python(requires_python) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            var ptr0 = isLikeNone(requires_python) ? 0 : passStringToWasm0(requires_python, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
            var len0 = WASM_VECTOR_LEN;
    ...
    update_source(cell_id, source) {
        try {
            ...
            const ptr0 = passStringToWasm0(cell_id, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(source, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
            const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {string | undefined}
 */
export function decode_presence_message(data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.decode_presence_message(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        let v2;
        if (r0 !== 0) {
...
export function encode_cursor_presence(peer_id, cell_id, line, column) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(peer_id, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(cell_id, wasm.__wbindgen_export2, wasm.__wbindgen_export4);
        const len1 = WASM_VECTOR_LEN;
